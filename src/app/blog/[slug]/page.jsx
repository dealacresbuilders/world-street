...
async function getBlogData(slug) {
  ...
  try {
    ...
    const res = await fetch(
      `https://faridabad-backend.onrender.com/blogs/getBlogBySlug/${slug}?domain=www.2bhkflatforsaleinfaridabad.com`,
      {
         cache: "force-cache",
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.2bhkflatforsaleinfaridabad.com/blog/${slug}`,
    },
  };
}
